<div class="home" data-style="opacity:0;" data-animate="opacity:1;" data-delay="500" data-time="500">
    ...
    <div class="sec_home_head" data-style="opacity:0;" data-animate="opacity:1;" data-delay="800" data-time="500">
	    ...
	    <a class="sec_home_head_more" href="<?php echo Yii::app()->baseUrl.'/'?>site/activity/"></a>
        <div class="sec_home_head_num"><?php echo $visitCount?></div>

        <a href="<?php echo Yii::app()->baseUrl.'/'?>information/update/" class="sec_home_head_btn1"  title="立即申请"></a>
        ...
        <div class="home_head_pop">
            <div class="home_head_pop_close"></div>
        </div>
    </div>
    <!--  -->
    <!--  -->
    <div class="section sec_home2 cs-clear">
        <div class="home_carefor home_infor" data-style="opacity:0;" data-animate="opacity:1;" data-delay="1100" data-time="500">
            <h2><a href="<?php echo Yii::app()->baseUrl.'/'?>care/">雅漾关怀</a></h2>
            <a href="<?php echo Yii::app()->baseUrl.'/'?>care/" class="home_more"></a>
        ...
        <div class="home_about home_infor" data-style="opacity:0;" data-animate="opacity:1;" data-delay="1300" data-time="500">
            <h2><a href="<?php echo Yii::app()->baseUrl.'/'?>about/">关于湿疹</a></h2>
            <a href="<?php echo Yii::app()->baseUrl.'/'?>about/" class="home_more"></a>
            <div class="home_infopop">
    ...
    <div class="section sec_home3 home_baike home_infor" data-style="opacity:0;" data-animate="opacity:1;" data-delay="1400" data-time="500">
        <h2><a href="<?php echo Yii::app()->baseUrl.'/'?>guide/">湿疹护理</a></h2>
        <a href="<?php echo Yii::app()->baseUrl.'/'?>guide/" class="home_more"></a>
