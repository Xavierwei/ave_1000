<div class="home" data-style="opacity:0;" data-animate="opacity:1;" data-delay="500" data-time="500">
    ...
    <div class="sec_homebar sec_homebar2">
        ...
        <a href="<?php echo Yii::app()->createUrl('/site/activity/')?>"></a>
    </div>

    <!--  -->
    <div class="sec_homefm" data-style="opacity:0;" data-animate="opacity:1;" data-delay="800" data-time="500">
        <div class="hometip">
            <div class="homefm_mun2"><?php echo $visitCount?></div>
            <div class="homefm_mun"><?php echo $recordCount?></div>
            <a href="<?php echo Yii::app()->createUrl('/information/update')?>" class="homefm_btn1"  title="立即申请"></a>
