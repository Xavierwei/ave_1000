<div class="activity">
    ...
    <div class="sec_homefm">
        <div class="actinfor">
            ...
            <a href="<?php echo Yii::app()->createUrl('/information/update')?>" class="actinfor_btn1"></a>
                ...
                <?php if($record):?>
                    <?php foreach($record as $key => $value):?>
                        <li class="home_caseli">
                            <a href="<?php echo Yii::app()->createUrl('/record/otherinfo/',array('id'=>$value->uid))?>" title="查看更多">
                                <img class="avatar" src="<?php echo Yii::app()->baseUrl . ($value->sex == '男' ? '/images/defaultAvatar/boy_' . rand(1,2) . '.png' :  '/images/defaultAvatar/girl_' . rand(1,2) . '.png' );?>" />
	                            <div class="over_avatar"></div>
	                            <div class="info">
		                            <p><?php echo $value->nickname;?></p>
		                            <p><?php echo $value->sex;?></p>
		                            <p>来自: <?php echo $value->city;?></p>
	                            </div>
	                            <div class="msg"><?php echo $value->reason;?></div>
                            </a>
                        </li>
                    <?php endforeach;?>
                <?php endif;?>
    ...
    <!--  -->
    <div class="act_intro">
        <a href="<?php echo Yii::app()->createUrl('/information/update')?>" class="act_btn1" title="即刻申请"></a>
        <a href="javascript:;" class="popshow_hos act_btn2" title="查看医院列表"></a>
	    <a href="<?php echo Yii::app()->baseUrl.'/'?>guide/" class="popshow_hos act_btn3 dis_mobile"></a>
    </div>
    <!--  -->
