...
//        die;
    ...
    public function actionExport()
    {
        ...
        foreach($data as $key=>$value)
        {
            ...
            $value->avatar= $value->avatar == '' ? '' : 'http://www.eau-thermale-avene.cn/eczemakids' . $value->avatar;
            $value->photo1=$value->photo1 == '' ? '' : 'http://www.eau-thermale-avene.cn/eczemakids' . $value->photo1;
            $value->photo2=$value->photo2 == '' ? '' : 'http://www.eau-thermale-avene.cn/eczemakids' . $value->photo2;
            $value->photo3=$value->photo3 == '' ? '' : 'http://www.eau-thermale-avene.cn/eczemakids' . $value->photo3;
            $value->case    =$value->case == '' ? '' : 'http://www.eau-thermale-avene.cn/eczemakids' . $value->case;
