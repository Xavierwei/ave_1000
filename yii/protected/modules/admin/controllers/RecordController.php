...
//        die;
    ...
    public function actionExport()
    {
        ...
        foreach($data as $key=>$value)
        {
            ...
            $value->avatar=Yii::app()->request->hostInfo . Yii::app()->baseUrl . $value->avatar;
            $value->photo1=Yii::app()->request->hostInfo . Yii::app()->baseUrl . $value->photo1;
            $value->photo2=Yii::app()->request->hostInfo . Yii::app()->baseUrl . $value->photo2;
            $value->photo3=Yii::app()->request->hostInfo . Yii::app()->baseUrl . $value->photo3;
            $value->case=Yii::app()->request->hostInfo . Yii::app()->baseUrl . $value->case;
